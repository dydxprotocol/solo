    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    Object.keys(Artifacts_1.default).forEach(function (contractName) {
                        var contract = Artifacts_1.default[contractName];
                    ...
                    return [4 /*yield*/, writeFileAsync(directory + filename, json)];
                case 2:
                    _a.sent();
