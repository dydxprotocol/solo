...
exports.StopLimitOrders = void 0;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.contracts.callConstantContractFunction(this.contracts.stopLimitOrders.methods.getOrderStates(orderHashes), options)];
                    case 1:
                        states = _a.sent();
